            ...
            <div className="work-card">
              ...
              <ul>
                <li>
                  ...
                  REST API capable of both single & batch requests.
                </li>
                <li>
                  <strong>Frontend Development: </strong> Developed a
                  React-based UI to serve as a framework for further
                  development, consuming the API.
                </li>
                <li>
            ...
            <div className="work-card">
              ...
              <ul>
                <li>
                  ...
                  service and handled customer inquiries and complaints
                  effectively.
                </li>
                <li>
                  <strong>Team Coordination: </strong>Organized workflow,
                  delegated tasks, and supported team efficiency during
                  high-pressure situations.
                </li>
                <li>
                  <strong>Problem Solving & Adaptability: </strong>Quickly
                  resolved operational issues and adapted to changing
                  priorities.
                </li>
                <li>
